  ...
  return (
    ...
    >
      <SliderPrimitive.Control
        className={cn(
          "relative flex w-full touch-none select-none items-center rounded-lg bg-secondary data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col data-disabled:opacity-50 data-horizontal:h-2",
          className,
        )}
      >
